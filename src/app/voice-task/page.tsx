          ...
          {guideOpen && (
            <div className="mt-5 space-y-5 border-t border-slate-700 pt-5 text-sm leading-relaxed text-slate-300">
              ...
              <ol className="space-y-4">
                ...
                <li><strong className="text-white">3. Aggiungi “Detta testo”.</strong> Cerca e seleziona <strong>Detta testo</strong>. Se disponibili, imposta <strong>Lingua: Italiano</strong> e <strong>Interrompi ascolto: Dopo una pausa</strong>. L’output è la variabile <strong>Testo dettato</strong>.</li>
                ...
                <li><strong className="text-white">5. Aggiungi “Ottieni contenuti dell’URL”.</strong> Imposta <strong>Metodo: POST</strong>. In <strong>Intestazioni</strong> aggiungi <strong>Authorization</strong> e come valore <code className="break-all text-amber-200">Bearer {TOKEN_PLACEHOLDER}</code>, sostituendo il placeholder con il token appena copiato. In <strong>Corpo richiesta</strong> scegli <strong>JSON</strong>, aggiungi la chiave <code>transcript</code> e assegnale <strong>Testo dettato</strong>.</li>
                <li><strong className="text-white">6. Estrai la conferma.</strong> Aggiungi <strong>Ottieni valore dizionario</strong>, usa la chiave <code>message</code> e come dizionario il risultato <strong>Contenuti dell’URL</strong>.</li>
                <li><strong className="text-white">7. Mostra il risultato.</strong> Aggiungi <strong>Mostra risultato</strong> e usa il valore del passo 6. La prova deve mostrare “Task creato: …” oppure “Creato da rivedere: …”.</li>
              ...
              <div className="rounded-xl border border-slate-700 bg-slate-950/45 p-4 text-xs text-slate-400"><strong className="text-slate-200">Da quel momento:</strong> premi il tasto Azione, detta per esempio “Chiamare Giuseppe domani, priorità alta, progetto WISE, responsabile Marco” e attendi la conferma.</div>
            </div>
          )}
        </section>
